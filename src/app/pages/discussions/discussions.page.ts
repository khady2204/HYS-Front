...
@Component({
  ...
  standalone: true,
  imports: [IonList, IonItem, IonItemSliding, IonItemOptions, IonIcon, IonAvatar, IonLabel, IonItemOption, IonBadge, IonContent, CommonModule, FormsModule, RouterLink, FloatingMenuComponent, DropdownDrawerComponent]
})
